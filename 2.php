...
echo "<br><Br>Вывод таблиц_27<br><br>";


 echo "<br><Br>Сотрудниуи<br><br>";
	...
	if($result->num_rows > 0) {
		echo "<table border=2>";
	echo "<tr><td>Код_клиента</td>"."<td>название</td>"."<td>представитель</td>"."<td>телефон</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr>
			<td>".$row["Код_клиента"]."</td>
			<td>".$row["название"]."</td>
			<td>".$row["представитель"]."</td>
				<td>".$row["телефон"]."</td>
				</tr>";
		}
		echo "</table>";
	...
	echo "<br><Br>Поставщики<br><br>";
	

	$sql = "SELECT * FROM postavchiki";
	$result = $conn->query($sql);
	if($result->num_rows > 0) {
		echo "<table border=2>";
	echo "<tr><td>Код_поставщика</td>"."<td>название</td>"."<td>представитель</td>"."<td>телефон</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr>
			<td>".$row["Код_поставщика"]."</td>
			<td>".$row["название"]."</td>
			<td>".$row["представитель"]."</td>
				<td>".$row["телефон"]."</td>
				</tr>";
	...
	echo "<br><Br>Заказано<br><br>";
	

	$sql = "SELECT * FROM zakazano";
	$result = $conn->query($sql);
	if($result->num_rows > 0) {
		echo "<table border=2>";
	echo "<tr><td>Код_заказа</td>"."<td>Код_препарата</td>"."<td>цена_реализации</td>"."<td>колличество</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr>
			<td>".$row["Код_заказа"]."</td>
			<td>".$row["Код_препарата"]."</td>
			<td>".$row["цена_реализации"]."</td>
				<td>".$row["колличество"]."</td>
				</tr>";
		}
		echo "</table>";
	}else {
	...
	if($result->num_rows > 0) {
		echo "<table border=2>";
	echo "<tr><td>Код_заказа</td>"."<td>Код_клиента</td>"."<td>Код_сотрудника</td>"."<td>Дата</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr>
			<td>".$row["Код_заказа"]."</td>
			<td>".$row["Код_клиента"]."</td>
