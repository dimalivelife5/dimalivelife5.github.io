...
<center><h3>Выберите таблицу</h3></center>
 <form action=1.php method = "post">
  <input type=submit name=ok3 value="Главная страница">
</form>
<form action=4.php method = "post">
  <input type=submit name=ok5 value="Сотрудники">
</form>
<form action=5.php method = "post">
  <input type=submit name=ok5 value="Клиенты">
</form>
<form action=6.php method = "post">
  <input type=submit name=ok5 value="Назначения">
</form>
<p><center><img src="icon.png" alt="Картинка"></center></p>
<form action=7.php method = "post">
  <input type=submit name=ok5 value="Поставщики">
</form>
<form action=8.php method = "post">
  <input type=submit name=ok5 value="Препараты">
</form>
<form action=9.php method = "post">
  <input type=submit name=ok5 value="Заказано">
</form>
<form action=10.php method = "post">
  <input type=submit name=ok5 value="Заказы">
</form>
